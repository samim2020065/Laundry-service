        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-7xl mx-auto mt-12 px-2">
          ...
          {packages.map((pkg, index) => (
            ...
            >
             ...
             <button className="bg-blue-100 hover:bg-blue-200 px-4 py-2 rounded-full font-semibold mt-auto" onClick={() =>
                  navigate(`/services/${pkg.slug}`, {
                    state: { service: pkg.title, description: pkg.description, img: pkg.img },
                  })
                }>
              Select Service
            </button>
